			...
			<div class="wrap-login200">
				<form id="Form2" class="login100-form validate-form"  >
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
                     <asp:TextBox ID="txt_pwd" runat="server" class="input100" type="password" name="pass" placeholder="Old Password"></asp:TextBox>
						
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                     <asp:TextBox ID="new_pass" runat="server" class="input100" type="password" 
                            name="pass" placeholder="New Password"></asp:TextBox>
                    ...
                    <div class="container-login100-form-btn">
						  ...
						  <asp:Button ID="btn_chngpass_submit"  class="button1" runat="server" BackColor="White" 
                        Font-Bold="True" Font-Names="Verdana" Font-Size="Large" ForeColor="#666666"   
                        Height="50px" Text="Change Password"    
                        ...
                        BorderStyle="None" ToolTip="Please Click Here" Width="194px" 
                              onclick="btn_chngpass_submit_Click" />
