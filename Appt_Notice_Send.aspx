<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Appt_Notice_Send.aspx.cs" Inherits="Appt_Notice_Send" %>
...
<body>
    ...
    <br />
      <asp:Label ID="Label1" runat="server" 
            Text="SELECT APPRENTICE NUMBER TO SEND MESSAGE" Font-Bold="True" 
      ...
      <div align=center>   
          <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" 
            ...
            Theme="PlasticBlue" Width="60%" style="margin-left: 0px; text-align: center; margin-top: 0px;" 
                    ...
                    Caption="Apprentice No">
                     ...
                     <DataItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" 
                                NavigateUrl='<%# "~/Appt_Notice_Send1.aspx?appt_name="+Eval("APPT_NAME","{0}") + "&appt_no="+Eval("APPT_NO","{0}")%>' Text=<%# Eval("APPT_NO")%> ></asp:HyperLink>
                        </DataItemTemplate>
                     <HeaderStyle HorizontalAlign="Center" />
                     <CellStyle HorizontalAlign="Center">
                     </CellStyle>
